...
urlpatterns = [
    ...
    path('blocklist/device/add/', views.device_block_add, name='device_block_add'),
    path('blocklist/device/<int:pk>/delete/', views.device_block_delete, name='device_block_delete'),
